...
* 24.) Javier Lugo-Pérez, **Zachary Hajian-Forooshani**, Ivette Perfecto, John Vandermeer. [*The importance of shade trees in promoting carbon storage in the coffee agroforest systems*](https://doi.org/10.1016/j.agee.2023.108594). **Agriculture, Ecosystems & Environment** 355, 108594 
...
leaf rust*](10.19103/as.2021.0096.24) Book chapter for Climate-smart production of coffee: Achieving sustainability and ecosystem services (ed. Prof. Reinhold Muschler). (2022) 
  <img style="padding: 0 15px; float: right;" src="spatial_structure_pathogen_spread.png" align="right" width="200">   
...
* 17.) Kevin Li, **Zachary Hajian-Forooshani**, Chenyang Su, Ivette Perfecto, JohnVandermeer. [*Reduced rainfall and resistant varieties mediate a critical transition in coffee rust disease*](https://doi.org/10.1038/s41598-022-05362-0). (2022) **Scientific reports** 12.1:1-9
...
<img style="padding: 0 15px; float: right;" src="CLR_snail_fig_pic.png" align="right" width="200">   
...
[*Trophic-specific responses to migration in empirical metacommunities*](https://doi.org/10.1111/oik.06342). **Oikos**, oik.06342

* 9.) Wesley Dáttilo... **Zachary Hajian-Forooshani**.. et al. (79 authors).[*ANTS OF MEXICO: incidence and abundance along the Nearctic-Neotropical interface*](https://doi.org/10.1002/ecy.2944). **Ecology**, e02944 
...
* <img style="padding: 0 15px; float: right;" src="leaf_litter_community_composition.png" align="right" width="200">   


### 2018
* 6.) Daniel Karp... **Zachary Hajian-Forooshani** ... et al. (153 Authors) (2018). [*Crop pests and
predators exhibit inconsistent responses to surrounding landscape composition*](https://doi.org/10.1073/pnas.1800042115). **Proceedings of the National Academy of Sciences**, 115(33), E7863-E7870.

* 5.) Iris Saraeny Rivera-Salinas, **Zachary Hajian-Forooshani**, Esteli Jiménez-Soto, Juan Antonio Cruz-Rodríguez & Stacey M. Philpott (2018). [*High intermediary mutualist density provides consistent biological control in a tripartite mutualism*](https://doi.org/10.1016/j.biocontrol.2017.12.002). **Biological Control** 118 (2018): 26-31.
...
* 1.) **Zachary Hajian-Forooshani**, David J. Gonthier, Linda Marin, Aaron L. Iverson, Ivette Perfecto. (2014) [*Changes in species diversity of arboreal spiders in Mexican coffee agroecosystems: untangling the web of local and landscape influences driving diversity*](https://doi.org/10.7717/peerj.623). **PeerJ** 2:e623
